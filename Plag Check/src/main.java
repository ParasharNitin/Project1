...
public class main {
    public static String strFileContents1;
    ...
    File filein1 = new File("C:\\Users\\sony\\Desktop\\Samples\\VI2\\src1.cpp");
    File fileout1 = new File("C:\\Users\\sony\\Desktop\\Samples\\src1.txt");
    
    try {
    FileInputStream finn1 = new FileInputStream(filein1);
    FileOutputStream fout1 = new FileOutputStream(fileout1);
      while (finn1.available() > 0) 
      {
        
          current = (char) finn1.read();
     ...
     File file1 = new File("C:\\Users\\sony\\Desktop\\Samples\\src1.txt");
    
        BufferedInputStream bin1 = null; 
      try
      {
       FileInputStream finn1 = new FileInputStream(file1); 
        bin1 = new BufferedInputStream(finn1);
          byte[] contents1 = new byte[1024];
           int bytesRead1;
           strFileContents1 = null;
        while( (bytesRead1 = finn1.read(contents1)) != -1)
       {
     ...
     File folder = new File("C:\\Users\\sony\\Desktop\\Samples\\VI2");
    File[] listOfFiles = folder.listFiles(); 
  //for(i=0;i<6;i++)
  {
      //      File fl = listOfFiles[i].getAbsoluteFile();

  }
  // System.out.print(" " +listOfFiles.length +" no of files ");
   
     for (int k = 1; k < listOfFiles.length; k++) {
         if (listOfFiles[k].isFile()) {
     // System.out.print("in k for loop \n");
    File filein2 = new File("C:\\Users\\sony\\Desktop\\Samples\\VI2\\"+listOfFiles[k].getName());
 //  File fileout1 = new File("C:\\Users\\TINKU\\Desktop\\Samples\\VI2\\src1.txt");
    File fileout2 = new File("C:\\Users\\sony\\Desktop\\Samples\\src2.txt");
...
//      System.out.println(args[0] + " does not exist.");
    ...
    /* for(i=0;i<=10;i++)
      ...
      // File file1 = new File("C:\\Users\\TINKU\\Desktop\\Samples\\VI2\\src1.txt");
       File file2 = new File("C:\\Users\\sony\\Desktop\\Samples\\src2.txt");
     //  BufferedInputStream bin1 = null;
       ...
       for( j = 0 ; j <= n2-m ; j++ )  
        {
          if(hv1==ob2[j].hash_value)
          {
               ...
               {    
                    ...
                    System.out.print("PLAGIARISED" +" pairs are :"+ob1[i].line_no+" "+ob2[j].line_no );
